...
x <- read.csv("Results/Signal/IsletaExtentSignal.csv")
x <- as.matrix(x)
...
write.table(surr.table,"Results/Surrogate/SurrogateTest_Isl_ExtDry.csv",col.names=NA,sep=",")
...
# Import Observed Times Series Data #
x <- read.csv("Results/Signal/SanAcaciaExtentSignal.csv")
x <- as.matrix(x)
...
write.table(surr.table,"Results/Surrogate/SurrogateTest_SanAcacia_ExtDry.csv",col.names=NA,sep=",")
