...
x <- read.csv("Results/Signal/IsletaDiversionSignal.csv")
x <- as.matrix(x)
...
write.table(surr.table,"Results/Surrogate/SurrogateTest_Isl_Diversion.csv",col.names=NA,sep=",")
...
# Import Observed Times Series Data #
x <- read.csv("Results/Signal/SanAcaciaDiversionSignal.csv")
x <- as.matrix(x)
...
write.table(surr.table,"Results/Surrogate/SurrogateTest_SanAcacia_Diversion.csv",col.names=NA,sep=",")
