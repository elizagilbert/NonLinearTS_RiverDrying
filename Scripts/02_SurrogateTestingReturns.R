...
x <- read.csv("Results/Signal/IsletaReturnSignal.csv")
x <- as.matrix(x)
...
write.table(surr.table,"Results/Surrogate/SurrogateTest_Isl_Returns.csv",col.names=NA,sep=",")
...
# Import Observed Times Series Data #
x <- read.csv("Results/Signal/SanAcaciaReturnSignal.csv")
x <- as.matrix(x)
...
write.table(surr.table,"Results/Surrogate/SurrogateTest_SanAcacia_Returns.csv",col.names=NA,sep=",")
