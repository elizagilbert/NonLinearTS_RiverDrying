...
x <- read.csv("Results/Signal/IsletaPrecipSignal.csv")
x <- as.matrix(x)
...
write.table(surr.table,"Results/Surrogate/SurrogateTest_Isl_Precipitation.csv",col.names=NA,sep=",")
...
# Import Observed Times Series Data #
x <- read.csv("Results/Signal/SanAcaciaPrecipSignal.csv")
x <- as.matrix(x)
...
write.table(surr.table,"Results/Surrogate/SurrogateTest_SanAcacia_Precipitation.csv",col.names=NA,sep=",")
