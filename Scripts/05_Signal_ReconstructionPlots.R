...
Recon_EscondidaDisch <- read.csv("Results/Reconstruction/EscondidaReconstruction.csv")
...
dat<- as.data.frame(cbind(Recon_SanAcaciaExt$dates, 
                          Recon_SanAcaciaExt$standardized, Recon_SanAcaciaExt$signal,
                          Recon_EscondidaDisch$standardized, Recon_EscondidaDisch$signal,
