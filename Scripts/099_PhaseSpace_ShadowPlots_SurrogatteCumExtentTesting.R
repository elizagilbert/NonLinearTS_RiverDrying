...
#All cummulative miles dry ####
ts <- read.csv("Data/Processed/DiversionSubreachData.csv") %>% 
...
scatterplot3d(Mx, type = "l", main="Shadow Extent",
...
write.table(surr.table,"Results/Surrogate/SurrogateTest_MileDaysIsleta.csv",col.names=NA,sep=",")
